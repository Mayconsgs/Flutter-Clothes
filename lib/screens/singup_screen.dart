...
class _SingUpScreenState extends State<SingUpScreen> {
  // Keys de identificação
  final _formKey = GlobalKey<FormState>();
  final _scaffoldKey = GlobalKey<ScaffoldState>();

  // Controllers de caixa de texto
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          FlatButton(
            ...
            child: Text("Logar", style: TextStyle(fontSize: 15.0)),
            onPressed: () {
  ...
  void _onFail() {
    _scaffoldKey.currentState.showSnackBar(
      SnackBar(
        content: Text("Não foi possível criar novo usuário. Tente novamente mais tarde."),
